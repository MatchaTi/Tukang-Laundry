...
public class ViewPesananResponseAll {
    ...
    public ViewPesananResponseAll() {
    }

    public ViewPesananResponseAll(Integer id, String namaPelanggan, String namaKasir, String namaPaket, Integer beratKg, String status, String tanggalPesan, String tanggalSelesai) {
        this.id = id;
